#!/usr/bin/env python3
"""Module for calculating the posterior probability of hypothetical probs."""
import numpy as np
...
def posterior(x, n, P, Pr):
    """Calculate the posterior probability for each hypothetical probability.
    ...
    Returns:
        numpy.ndarray: 1D array of posterior probabilities for each value
            in P given x and n.
    ...
    return intersection(x, n, P, Pr) / marginal(x, n, P, Pr)#!/usr/bin/env python3
"""Module for calculating the posterior probability of hypothetical probs."""
import numpy as np
